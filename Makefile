...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/share/CaH/lib
...
SOURCES       = src/CaH.cpp moc_ping.cpp
OBJECTS       = CaH.o \
		moc_ping.o
...
Makefile: CaH.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/CaH1.0.0 || mkdir -p .tmp/CaH1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CaH1.0.0/ && $(COPY_FILE) --parents exec.h ping.h .tmp/CaH1.0.0/ && $(COPY_FILE) --parents src/CaH.cpp .tmp/CaH1.0.0/ && $(COPY_FILE) --parents translations/CaH-cs_CZ.ts .tmp/CaH1.0.0/ && (cd `dirname .tmp/CaH1.0.0` && $(TAR) CaH1.0.0.tar CaH1.0.0 && $(COMPRESS) CaH1.0.0.tar) && $(MOVE) `dirname .tmp/CaH1.0.0`/CaH1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CaH1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_ping.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ping.cpp
moc_ping.cpp: /usr/include/qt5/QtCore/QObject \
...
CaH.o: src/CaH.cpp /usr/include/qt5/QtQuick/QtQuick \
		...
		exec.h \
		ping.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o CaH.o src/CaH.cpp
...
uninstall_qm: FORCE
	...
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/CaH/translations/ 
...
uninstall_qml: FORCE
	...
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/CaH/ 
...
uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/CaH.png
