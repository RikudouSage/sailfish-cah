...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Ping_t, stringdata) + ofs \
...
void Ping::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { bool _r = _t->networkAccessible();
...
const QMetaObject Ping::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ping.data,
      qt_meta_data_Ping,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Ping.stringdata))
